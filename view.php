...
// Prepare the SQL statement to fetch the record based on the filename and department
$stmt = $connection->prepare("SELECT * FROM form WHERE filename = ? AND department = ?");
$stmt->bind_param("ss", $filename, $_SESSION['department']);
$stmt->execute();
...
<div class="container">
    ...
    <div class="action-buttons">
        ...
        <a href="javascript:void(0);" onclick="confirmDelete('<?php echo $row['filename']; ?>')" class="btn btn-danger">Delete</a>
    </div>
